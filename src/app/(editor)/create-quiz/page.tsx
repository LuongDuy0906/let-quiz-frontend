...
export default function CreateQuizPage() {
    ...
    // --- HƯỚNG ĐI MỚI: QUẢN LÝ TẬP TRUNG TRONG MỘT OBJECT QUIZ ---
    const [quiz, setQuiz] = useState(createDefaultQuiz());
    ...
    const handleDeleteQuestion = (indexToDelete: number) => {
        ...
        // Điều chỉnh activeIndex để không bị trỏ vào mảng trống
    ...
    const addNewQuestion = () => {
        const newEmptyQ = createDefaultQuestion('single'); // Mặc định hoặc rỗng
    ...
    const handleSaveQuiz = async () => {
        ...
        const res = await quizService.saveQuiz(finalQuizData);
